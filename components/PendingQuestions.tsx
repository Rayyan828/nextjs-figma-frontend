  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-3 ml-3 ml-0 h-[180px] flex flex-col">
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="bg-blue-100 text-blue-600 rounded-full px-2 py-0.5 text-[10px] font-medium">
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <div className="flex items-center mb-0.5">
                  ...
                  <span className="text-[10px] text-gray-500 ml-1">@{q.user.username}</span>
                </div>
                <p className="text-xs text-gray-700 mb-0.5 leading-tight">{q.question}</p>
                <p className="text-[10px] text-gray-400">{q.timeAgo}</p>
              </div>
            </div>
          </div>
        ))}
